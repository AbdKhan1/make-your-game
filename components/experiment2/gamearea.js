...
export function setupGameView() {
  ...
  rightColumn.style.height =
    gameViewSettings.gameViewHeight - gameViewSettings.borderWidth + "px";
  ...
  var windowSize = window.matchMedia(
  ...
  topWall.style.width =
    gameViewSettings.gameViewWidth - gameViewSettings.borderWidth * 2 + "px";
...
function columnView(windowSize) {
  ...
  if (windowSize.matches) {
    ...
    rightColumn.style.width =
      gameViewSettings.gameViewWidth - 2 * gameViewSettings.borderWidth + "px";
  } else {
